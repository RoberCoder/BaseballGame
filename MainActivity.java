...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            getNumButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (inputTextCount < 3) {
                        ...
                        Toast.makeText(getApplicationContext(), "히트 버튼을 누르기", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
        ...
        backSpaceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(inputTextCount>0) { //눌렀다 취소했을때 다시 버튼 활성화 하기
                ...
                Toast.makeText(getApplicationContext(),"숫자 입력 필요 ",Toast.LENGTH_SHORT).show();
                }
        ...
        hitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(inputTextCount<3){
                    ...
                    String resultCount;
                    if(countCheck[0]==3){
                        resultCount = "1 [" + userNumbers[0] + " " + userNumbers[1] + " " + userNumbers[2] + "] 아웃입니다 ";
